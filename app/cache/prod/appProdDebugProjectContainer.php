...
class appProdDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/wamp/www/PIDEV1/SprintWeb/app/cache/prod',
            ...
            'session.save_path' => 'C:/wamp/www/PIDEV1/SprintWeb/app/cache/prod/sessions',
            ...
            'router.resource' => 'C:/wamp/www/PIDEV1/SprintWeb/app/config/routing.yml',
            ...
            'debug.container.dump' => 'C:/wamp/www/PIDEV1/SprintWeb/app/cache/prod/appProdDebugProjectContainer.xml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/PIDEV1/SprintWeb/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/PIDEV1/SprintWeb/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/PIDEV1/SprintWeb/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/PIDEV1/SprintWeb/app/cache/prod/doctrine/orm/Proxies',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/PIDEV1/SprintWeb/app/cache/prod/annotations', true);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setProxyDir('C:/wamp/www/PIDEV1/SprintWeb/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_197b4f9bc4f5bc58305cf119c4bd2f71a369845444f73abc67d0fbc2e7ab99a3');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/PIDEV1/SprintWeb/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/PIDEV1/SprintWeb/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/PIDEV1/SprintWeb/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/PIDEV1/SprintWeb/app/../web', true);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/PIDEV1/SprintWeb/app/cache/prod');
    }
